...
export default function Index() {
    return (
        <main className={`flex flex-col items-center h-screen text-text-subtle ${circular.className}`}>
            <div className="absolute flex flex-col items-center h-full min-w-md max-w-7xl mx-auto w-full px-12 text-slate-50">
                <Header />
            </div>
            <section className='flex flex-col items-center text-center w-full bg-playground bg-cover bg-bottom py-52 px-12'>
                <div className='flex flex-row max-w-7xl w-full'>
                    <div className='flex flex-col w-1/2 text-left'>
                        <h2 className='text-7xl text-white font-semibold leading-tight'>A playground for your creative code</h2>
                        <p className='text-xl text-slate-100 mt-12 leading-relaxed w-3/4'>Unleash new dimensions of creative coding with our unique graphics environment</p>
                        <div className='flex flex-row flex-nowrap items-center gap-x-4 mt-20'>
                            ...
                            <div className='px-8 py-3'>
                                <Link className='text-white' href="/learn">Learn More</Link>
                            </div>
                        </div>
            ...
            <section className="flex flex-col items-center text-center pt-16 pb-32 w-full px-12 bg-neutral-100">
                <div className='flex flex-col max-w-5xl w-full'>
                    ...
                    <p className="mt-16 text-2xl leading-loose max-w-xl w-full">
                        Join the community of coders, artists & visionaries who have embraced Alma as their creative environment
                    </p>
                    <div className='flex flex-row flex-nowrap items-center gap-x-4 mt-20'>
                        <button
