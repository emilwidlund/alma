-- CreateEnum
CREATE TYPE "LayerType" AS ENUM ('FRAGMENT', 'CIRCUIT');

-- CreateEnum
CREATE TYPE "BlendingMode" AS ENUM ('NONE', 'NORMAL', 'ADDITIVE', 'SUBTRACTIVE', 'MULTIPLY');
...
CREATE TABLE "Layer" (
    ...
    "blendingMode" "BlendingMode" NOT NULL DEFAULT 'NORMAL',
